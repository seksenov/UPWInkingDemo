...
(function () {
    ...
    function handlePointerDown(evt) {
        if ((evt.pointerType === "pen") || ((evt.pointerType === "mouse") && (evt.button === 0))) {
            ...
            inkContext.lineWidth = pressureWidth;
            setDefaults();
    ...
    function inkColor(evt) {
        inkContext.strokeStyle = evt.currentTarget.value;
        inkMode();
    ...
    function highlightColor(evt) {
        ...
        hlContext.strokeStyle = evt.currentTarget.value;
        highlightMode();
    ...
    document.addEventListener("DOMContentLoaded", function () {
        document.querySelector("#strokeColors").addEventListener("change", inkColor, false);
        document.querySelector("#highlightColors").addEventListener("change", highlightColor, false);
        document.querySelector("#highlightWidths").addEventListener("change", setHighlightWidth, false);
        document.querySelector("#clearButton").addEventListener("click", clear, false);
        document.querySelector("#allOptions").addEventListener("change", dealWithOptions, false);
